...
<!-- HEADER -->
	...
	<section id="page">
                ...
                <li class="reader_book_info_detail">Kitabýn Adý: <span class="reader_book_info_detail_data">Örnek Kitap</span></li>
                ...
                <li class="reader_book_info_detail">Editörler: <span class="reader_book_info_detail_data">Örnek Kiþi</span></li>

                <div class="vertical-divider"></div>
                <div class="clearfix"></div>
                
                <li class="reader_book_info_detail">Sayfa Sayýsý: <span class="reader_book_info_detail_data">200</span></li>

                <div class="vertical-divider"></div>
                <div class="clearfix"></div>
                
                <li class="reader_book_info_detail">Yayýnlanma Tarihi: <span class="reader_book_info_detail_data">01.05.2014</span></li>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header reader_info_header">
									...
									<div class="reader_book_name">Kitabýn Adý: <span class="reder_book_name_data">Örnek Kitap</span></div>
                                     <div class="btn-group">
